...
export default function Example() {
  return (
    ...
    <div className="lg:flex lg:items-center lg:justify-between">
      ...
      <h1 class="py-2 mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-primaryBrown">Meet <mark class="px-2 text-lund bg-blue-600 rounded dark:bg-primaryBrown">Arnav!</mark></h1>
      <section></section>
